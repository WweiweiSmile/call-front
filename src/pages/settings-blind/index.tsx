 ...
 * 盲注设置页。
 *
 * 内容与拆分之前完全一致，只是从「设置」页整体搬到了子页 ——
 * 设置页现在是入口列表，不再自己承载表单。
 *
 * 服务端契约仍是 GET/PUT /preferences，与模型配置那对接口互相独立
 */
const SettingsBlindPage: React.FC = () => {
  ...
  return (
    <PageLayout
      className='settings-form settings-blind-page'
      contentClassName='settings-form-content'
      header={<PageHeader title='盲注设置' showBack />}
      bottom={
    ...
    >
      {!loaded && (
        <View className='section'>
          ...
          <View className='retry-btn' onClick={() => refresh()} data-testid='btn-reload-blinds'>
...
export default SettingsBlindPage;
